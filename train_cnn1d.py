...
def main():
    ...
    # use same sequence builder as LSTM/GRU; T 300 works with 16k/25ms hop
    ...
    model = CNN1DRegressor(n_mels=n_mels, hidden=128, dropout=0.2).to(device)
    ...
    with open("results/cnn1d_audio_melspec.json","w") as f: json.dump(best[1], f, indent=2)
    print("Saved results/cnn1d_audio_melspec.json")
